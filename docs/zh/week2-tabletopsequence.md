...
![足底三角](../figures/Theory/feetTriangle.jpg)
...
![四角板凳](../figures/pocketYogaImages/ArmLegSupport_Box_chakravakasana.png)
...
![猫式](../figures/pocketYogaImages/ArmLegSupport_Cat_marjariasana.png)

- **牛式 (Cow Pose)**：

![牛式](../figures/pocketYogaImages/ArmLegSupport_Cow_bitilasana.png)

- **大猫伸展式 (Puppy Pose)**：

![小狗式](../figures/pocketYogaImages/Prone_Extended Puppy_uttana shishosana.png)

- **虎式 (Tiger Pose)**：

![虎式](../figures/pocketYogaImages/ArmLegSupport_Tiger_vyaghrasana.png)
