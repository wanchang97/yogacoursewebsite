...
**Vier Phasen in jeder Einheit** – so ist jede Stunde voll, aber nie überladen:
Aufwärmen (Atem · Sitz-Aufwärmen · Vierfüßler) → **Flow** (Steh- & Balance-Sequenz) → **Cool-down** (sitzende Dehnung) → **Abschluss** (Endentspannung · Chanting).

**Ein Abschnitt pro Einheit im Detail.** Das Vertiefen läuft wie die *drei Runden* in den Wochen-Kapiteln: einmal ohne Musik erklären, einmal mit Musik mitüben. Ein Detail-Durchgang kostet gut das Doppelte seiner Musiklänge – deshalb vertiefen wir pro Einheit **nur einen** großen Abschnitt.

**Modulare Musik.** Die Sequenz besteht aus einzelnen Tracks (siehe Abschnitt C). In den Lehr-Einheiten spielst du nur die Tracks, die du *wiederholst*, und ersetzt den neuen Abschnitt durch die langsame Ansage. Den kompletten, durchgehenden Fluss heben wir uns für **Einheit 5** auf.

**Zeitanker:** Vierfüßler → Endentspannung mit Musik ≈ **50 Minuten**. 75 − 50 ≈ **25 Minuten** Spielraum pro Einheit für Atem, Aufwärmen, Chanting und *ein* Detail-Thema.

---

## B. Die fünf Einheiten
...
## C. Audio-Tracks (Referenz)

| # | Track | Zeit | Abschnitt | Phase |
|---|-------|------|-----------|-------|
| – | Sitzende Atemübung | ~5 (ohne Musik) | Atem | Aufwärmen |
| – | Sitz-Aufwärmen | ~4 (ohne Musik) | Seiten, Nacken, Drehung | Aufwärmen |
| 1 | flow_warmup | 7:06 | Vierfüßler | Aufwärmen |
| 2 | warmup+flow | 9:51 | Stehsequenz A | Flow |
| 3 | warmup+flow anotherside | 9:51 | Stehsequenz B | Flow |
| 4 | flow_cooldown | 7:59 | Balance-Challenge | Flow |
| 5 | Sitstretching Respite | 5:29 | Sitzende Dehnung A | Cool-down |
| 6 | Sitstretching AnotherSide | 5:29 | Sitzende Dehnung B | Cool-down |
| 7 | Savasana Softhearted | 3:46 | Endentspannung | Abschluss |
| ∑ | FullVinyasaYoga (zusammengeführt) | 50:11 | Vierfüßler → Endentspannung | durchgehend |

Einzeltracks = zum Unterrichten (dazwischen anhalten). Zusammengeführte Datei = durchgehendes Üben.

---

## D. Rhythmus & Haltung

In jeder Einheit wiederholen wir mit Musik das, was bis zur letzten Einheit geübt wurde – so wächst im Körper durch Wiederholung ein Gedächtnis. Wähl die Wiederholung bewusst: eine Seite genügt oft, du musst nicht jedes Mal alles spielen.

Und: lieber 3–5 Minuten früher schließen als überziehen. Eine Stunde, die ruhig endet, trägt mehr als eine randvolle. Die Endentspannung bekommt immer ihre Zeit.

> **Übungswerkzeug**: Zwischen den Einheiten – täglich 3 Minuten sitzen und nur den Atem beobachten. Solange du atmen kannst, kannst du Yoga üben.
